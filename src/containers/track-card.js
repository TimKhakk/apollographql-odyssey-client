 ...
 */
const TrackCard = ({ id, title, thumbnail, author, length, modulesCount }) => {
  const mutationConfig = {
    variables: {
      incrementTrackViewsId: id,
    },
    onCompleted: data => console.log(data), // This callback function fires when mutation is completed
  }

  const [incrementTrackViews] = useMutation(INCREMENT_TRACK_VIEWS, mutationConfig)
  return (
